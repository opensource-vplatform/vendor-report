...
//获取数据集数据url
const batchGetDatasURL = `/api/GetVDataWebExcelDatas`;
//获取数据集url
const queryAllDataNodesURI = `/api/QueryAllDataNodes`;
//保存报表配置数据
const saveReportConfigURI = `/api/SaveVDataWebExcel`;
//获取报表配置数据
const getReportConfigURI = `/api/GetVDataWebExcel`;
