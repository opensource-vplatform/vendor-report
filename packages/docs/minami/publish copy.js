...
function buildNav(members) {
  members.modules.forEach(function (item) {
    console.log(item)
  })
  ...
  nav = nav.concat(buildMemberNav(members.classes, '类定义列表', seen, linkto))
  nav = nav.concat(buildMemberNav(members.modules, '模块定义列表', {}, linkto))
