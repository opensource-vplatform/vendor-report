            ...
            (Handler.gen = function (t, e, n) {
                ...
                Handler.extend({
                    ...
                    string: function (t) {
                        ...
                        if (t.template.length) {
                            for (
                                void 0 == t.rule.count && (o += t.template),
                                    e = 0;
                                e < t.rule.count;
                                e++
                            )
                                o += t.template;
                            for (
                                n = o.match(Constant.RE_PLACEHOLDER) || [],
                                    e = 0;
                                e < n.length;
                                e++
                            )
                ...
                Handler.extend({
                    ...
                    placeholder: function (
                        ...
                        if (
                            !(key in Random || lkey in Random || okey in Random)
                        )
                            return placeholder;
                    ...
                    getValueByKeyPath: function (t, e) {
                        var n = t,
                            ...
                            a = [];
                        '/' === t.charAt(0)
                            ? (a = [e.context.path[0]].concat(
                                  this.normalizePath(r)
                              ))
                            : r.length > 1 &&
            ...
            t.exports = {
                parse: function (t) {
                    ...
                    var e = (t || '').match(r.RE_KEY),
                        ...
                        c = i && parseInt(i[2], 10),
                        h = i
                            ? (!i[2] && parseInt(i[1], 10)) || a.integer(s, c)
                            : void 0,
                        p = {
                            parameters: e,
                            range: n,
            ...
            (u.gen = function (t, e, n) {
                ...
                u.extend({
                    ...
                    'capture-group': function (t, e, n) {
                        return (
                            (e = this.gen(t.body, e, n)), (n[n.guid++] = e), e
                        );
                    },
                    ...
                    quantified: function (t, e, n) {
                        e = '';
                        for (
                            var r = this.quantifier(t.quantifier), a = 0;
                            r > a;
                            a++
                        )
                    ...
                    properties: function (t, e, n, r) {
                        ...
                        if (t.properties) {
                            ...
                            for (var s = 0; s < i.length; s++)
                                r.push.apply(
                                    r,
                                    this.diff(t.properties[s], e[i[s]], i[s])
                                );
                            return r.length !== o ? !1 : !0;
                        }
                    },
            ...
            (r._settings = { timeout: '10-100' }),
                ...
                l.extend(r.prototype, {
                    ...
                    setRequestHeader: function (t, e) {
                        if (!this.match)
                            return void this.custom.xhr.setRequestHeader(t, e);
