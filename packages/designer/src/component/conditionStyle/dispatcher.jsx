...
const dispatcher = {
  ...
  rowColumnVisibleRulesGreaterThan: (spread, dispatcher) => {
    dispatcher(
      setRowColumnVisibleCompareConfig({
        title: '大于',
        desc: '为大于以下值',
  ...
  rowColumnVisibleRulesLessThan: (spread, dispatcher) => {
    dispatcher(
      setRowColumnVisibleCompareConfig({
        title: '小于',
        desc: '为小于以下值',
  ...
  rowColumnVisibleRulesBetween: (spread, dispatcher) => {
    dispatcher(
      setRowColumnVisibleBetweenConfig({
        title: '介于',
        desc: '为介于以下值',
  ...
  rowColumnVisibleRulesEqualTo: (spread, dispatcher) => {
    dispatcher(
      setRowColumnVisibleCompareConfig({
        title: '等于',
        desc: '为等于以下值',
