    ...
    return [
        {
            value: '宋体',
            title: '宋体',
            text: <span style={{ fontFamily: '宋体',fontSize:14 }}>宋体</span>,
        },
        {
            value: '楷体',
            title: '楷体',
        ...
        },
        {
            value: '新宋体',
            title: '新宋体',
            text: <span style={{ fontFamily: '新宋体',fontSize:14 }}>新宋体</span>,
        },
        {
            value: 'SimSun',
            title: 'SimSun',
            text: <span style={{ fontFamily: 'SimSun',fontSize:14 }}>SimSun</span>,
        },
