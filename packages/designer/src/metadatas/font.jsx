...
export const getFontFamilies = function () {
  if (Array.isArray(window.FONT_FAMILIES_CN_Customize))
    return FONT_FAMILIES_CN_Customize.concat(FONT_FAMILIES_En);
  return FONT_FAMILIES_CN.concat(FONT_FAMILIES_En);
};
