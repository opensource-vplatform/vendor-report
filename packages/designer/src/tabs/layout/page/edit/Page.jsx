...
import { isNumber } from '@toone/report-util';
            ...
            <VGroupItem>
              ...
              <Radio label='缩放比例：' value={1}>
                <Integer
                  ...
                  onChange={(zoomFactor) => dispatch(setZoomFactor(zoomFactor))}
                ></Integer>
                <Text>% 正常尺寸</Text>
              </Radio>
              <Radio label='调整为：' value={0}>
                <Integer
                  ...
                  onChange={(val) => dispatch(setFitPagesWide(val))}
                ></Integer>
                <Text>页宽</Text>
                <Integer
                  ...
                  style={integerStyle}
                  disabled={scaleType != 0}
                  onChange={(val) => dispatch(setFitPagesTall(val))}
                ></Integer>
                <Text>页高</Text>
              </Radio>
            </VGroupItem>
        ...
        <Padding>
          <VGroupItem>
            <HLayout style={hStyle}>
              ...
              <Select
                value={isNumber(paperKind) ? paperKind + '' : paperKind}
                datas={getAll()}
            ...
            <HLayout style={hStyle}>
              ...
              <Integer
                value={printQuality}
                style={inputStyle}
                onChange={(val) => dispatch(setPrintQuality(val))}
              ></Integer>
            </HLayout>
            <HLayout style={hStyle}>
              ...
              <Integer
                ...
                style={inputStyle}
                onChange={(val) => dispatch(setFirstPageNumber(val))}
              ></Integer>
            </HLayout>
          </VGroupItem>
        </Padding>
